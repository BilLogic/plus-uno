...
// success. Its deploy command was `npx wrangler deploy`, which never invoked
// scripts/deploy.mjs — so no --define reached the bundle and none of the gates
// ran. Disconnected 2026-08-28 (#278); the hold stays, because it is what would
// notice a third one, or that one coming back.
//
