...
const LESSONS_BY_TUTOR = {
    ...
    10: [
        { id: 1, name: 'SMART Goals', completed: true, accuracy: 50, timeSpentMins: 20 },
        { id: 2, name: 'Active Listening', completed: true, accuracy: 55, timeSpentMins: 15 },
        { id: 3, name: 'Questioning Techniques', completed: false, accuracy: null, timeSpentMins: 5 },
    ],
};
