...
export default {
    ...
    parameters: {
        docs: {
            description: {
                component: 'CTA button component with different states: not started (Get Started), in progress (Continue), completed (Review). Get Started, Continue, and Review all use primary filled styling.'
            }
        }
    },
    argTypes: {
    ...
    render: () => (
        <div style={{ padding: 'var(--size-section-pad-y-lg, 24px)' }}>
            ...
            <ul className="body2-txt">
                ...
                <li><strong>completed</strong>: "Review" - Primary filled button</li>
            </ul>
        </div>
    )
};
