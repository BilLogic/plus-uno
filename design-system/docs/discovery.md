...
| Topic | Path |
|-------|------|
| All UI components (index) | `design-system/agent-views/components/index.md` — existence only; props and usage live in Storybook MDX |
...
**Build a form**
→ `docs/patterns/forms.md` → `agent-views/components/index.md` → `agent-views/tokens/tokens.md`

**Build a page / dashboard**
→ `docs/patterns/layout.md` → `agent-views/components/index.md` → `agent-views/tokens/tokens.md`

**Dialog / Modal**
→ `agent-views/components/index.md` (confirm `Modal`) → `docs/patterns/layout.md` (Modal skeleton)
