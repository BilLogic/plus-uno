...
| Path | Purpose |
|------|---------|
| `packages/plus-ds/src/components/` | React components (Button, Badge, Alert, etc.) |
| `packages/plus-ds/src/forms/` | Form components (Input, Select, DatePicker, etc.) |
| `packages/plus-ds/src/specs/` | Complex UI sections (Admin, Login, Profile, etc.) |
| `packages/plus-ds/src/styles/` | SCSS styles and tokens |
| `packages/plus-ds/guidelines/` | Documentation (design-tokens, guides, workflows) |
| `playground/prototyping/` | Prototype experiments |
| `.storybook/` | Storybook configuration |
| `develop/foundations/` | Agent foundation docs (tech-stack, terminology, etc.) |
