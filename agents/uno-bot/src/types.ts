...
export interface Env {
  ...
  // GEMINI_API_KEY (Developer API — simplest) OR the service-account pair
  // (Vertex AI): GEMINI_SA_EMAIL + GEMINI_SA_PRIVATE_KEY. The service-account
  // path ALSO powers the Vertex-Claude lane (vertex/claude.ts) — same token.
