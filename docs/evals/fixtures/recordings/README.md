...
**34 of 45 fixture cases are recorded** — 34 `captured`. The other 11 are **unreachable**: R21, G1, G2, G3, G4, G5, G6, G7, GU1, GU2, W1. Each skips by name on the pull-request gate, so nothing about it is measured there — record it (`-f cases=<id>` below) or accept that it gates nothing.
<!-- /census:recorded -->
