                    ...
                    <div className="sb-ai-agent__skills-router-canvas">
                        ...
                        <ul className="sb-ai-agent__skills-router-cards">
                            <SkillsRouterSkillCard
                                ...
                                trigger={'"scaffold", "new prototype", "create prototypes"'}
                            />
                            <SkillsRouterSkillCard
                                theme="review"
                                num="2"
...
const StorybookAIAgent = ({ pageContext = 'Tutor Training Progress Page', userName = 'Ashley' }) => {
    ...
    const matchSkillIntent = (text) => {
        ...
        const skillTriggers = [
            ...
            { id: 'prototype',patterns: [/\bscaffold\b/, /\bnew prototype\b/, /\bcreate prototypes\b/] },
            // review: require "review this prototype/design/prototypes" phrasing, not "review this component"
            { id: 'review',   patterns: [/\bquality check\b/, /\breview (this |my |the )?(prototype|prototypes|design|work)\b/, /\bvalidate (this |my |the )?(prototype|prototypes|design|work)\b/] },
