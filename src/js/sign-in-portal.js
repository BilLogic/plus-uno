 ...
 * Following coding standards from docs/guidelines/coding-standards.md
...
function initializeSignInPortal() {
    ...
    if (googleButton && googleButton.classList.contains("pbtn")) {
        ...
        if (googleButtonContent) {
            // Placeholder div for Google icon - please provide google-icon.svg or google-icon.png
            const googleIcon = document.createElement("div");
            googleIcon.className = "google-icon";
            googleIcon.title = "Google icon placeholder - please provide google-icon.svg or google-icon.png";
    ...
    // Add Clever image placeholder to button
    if (cleverButton && cleverButton.classList.contains("pbtn")) {
        ...
        if (cleverButtonContent) {
            ...
            // Placeholder div for Clever image - please provide clever-image.svg or clever-image.png
            const cleverImage = document.createElement("div");
            cleverImage.className = "clever-image";
            cleverImage.title = "Clever image placeholder - please provide clever-image.svg or clever-image.png";
