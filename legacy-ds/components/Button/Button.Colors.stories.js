/**
 * Button Color Variants Stories
 * 
 * Shows all color variants for filled buttons.
 * Color variants are the color tokens applied to buttons.
 */
...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: 'Color variants are color tokens applied to buttons. Shows all available color styles for filled buttons.',
      },
    },
  },
};
