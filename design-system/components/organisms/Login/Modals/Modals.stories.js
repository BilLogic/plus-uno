/**
 * Login Organism - Modals
 * 
 * Modal dialogs used in login/authentication flows.
 * 
 * ## Components in this Category
 * 
 * - **NotificationsModal**: Modal for displaying notifications with variants:
 *   - type A
 *   - type B
 * 
 * Each modal variant will have its own story showing different notification types.
 */

export default {
  title: 'Organisms/Login/Modals',
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
        component: 'Modal dialogs used in login/authentication flows. These modals provide important notifications and confirmations during the login process.',
      },
    },
  },
};
