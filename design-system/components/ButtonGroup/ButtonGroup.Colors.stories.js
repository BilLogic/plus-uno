/**
 * Button Group Color Variants Stories
 * 
 * Shows all color variants for button groups.
...
export default {
  title: 'Components/ButtonGroup/Colors',
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
        component: 'Color variants are color tokens applied to button groups. All button groups use tonal fill style with state-layer backgrounds.',
      },
    },
  },
};
...
/**
 * All Colors
 * Side-by-side comparison of all color variants
 */
