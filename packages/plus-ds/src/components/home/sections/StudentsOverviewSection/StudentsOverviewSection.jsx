...
import './StudentsOverviewSection.scss';
...
/**
 * StudentsOverviewSection component for Home page
...
const StudentsOverviewSection = ({
    ...
    const sectionClasses = [
        'plus-students-overview-section',
        `plus-students-overview-section--${variant}`,
        className
    ].filter(Boolean).join(' ');
    ...
    if (variant === 'variant2') {
        return (
            <div id={id} className={sectionClasses} style={style}>
                <div className="plus-students-overview-section-overview">
                    <h5 className="plus-students-overview-section-title h5">
                        Students Overview
                    </h5>
                    <div className="plus-students-overview-section-cards">
                        <div className="plus-students-overview-section-cards-row">
                ...
                <div className="plus-students-overview-section-students">
                    <div className="plus-students-overview-section-students-header">
                        <h5 className="plus-students-overview-section-title h5">
                            My Students
                        </h5>
                        <Button
...
StudentsOverviewSection.propTypes = {
    id: PropTypes.string,
