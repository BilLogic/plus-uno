...
- Image (session asset — shell packaging into `_wip` blocked this session):  
  `/Users/billguo/.cursor/projects/Users-billguo-Desktop-Vibe-Coding-PLUS-UNO-plus-vibe-coding-starting-kit/assets/tutor-home-feeling-concept.png`  
  (~1.8 MB). To place next to this spec:

```bash
cp "/Users/billguo/.cursor/projects/Users-billguo-Desktop-Vibe-Coding-PLUS-UNO-plus-vibe-coding-starting-kit/assets/tutor-home-feeling-concept.png" \
  "prototypes/_wip/tutor-home-feeling-concept.png"
```
