/**
 * @fileoverview LessonsWelcomeRow component for Training Lessons specs
...
/**
 * Creates a LessonsWelcomeRow component
 ...
 */
export function createLessonsWelcomeRow({
    userName = 'Charmaine',
    onSignUp = null,
    onViewSchedule = null
} = {}) {
    ...
    header.style.gap = 'var(--size-element-gap-sm)'; // 8px
    ...
    headerText.style.fontSize = 'var(--font-size-h3)'; // 28px
