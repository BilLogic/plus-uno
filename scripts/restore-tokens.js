...
const primitivesScssPath = path.join(process.cwd(), 'develop/tokens/_primitives.scss');
const semanticsScssPath = path.join(process.cwd(), 'develop/tokens/_spacing_semantics.scss');
