...
const config = {
  ...
  viteFinal: async (config) => {
    ...
    config.root = rootDir;
    // Use '/' in dev so dynamic import chunks resolve; base: './' causes 404 on playground story modules
    config.base = '/';
    ...
    const playgroundPath = path.resolve(rootDir, 'playground', 'prototyping');
