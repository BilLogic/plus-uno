/**
 * Toolkit Organism - Cards
 */

export default {
  title: 'Organisms/Toolkit/Cards',
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
        component: 'Card components for toolkit.',
      },
    },
  },
};
...
export const Overview = {
  render: () => {
    ...
    const components = [
      { name: 'CallOffAlert', description: 'Alert for call-offs with types: checkbox for recurring call-off, Update, warning' },
    ];
