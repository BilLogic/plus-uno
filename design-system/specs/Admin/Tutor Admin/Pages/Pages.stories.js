...
export const TutorsOverviewPage = {
  render: (args) => {
    const page = createTutorsOverviewPage({ showModal: false });
...
export const TutorsOverviewPageWithModal = {
  render: (args) => {
    const page = createTutorsOverviewPage({ showModal: true, modalTab: "Info" });
    return createPageWidthWrapper(page, args.pageWidth);
  },
  argTypes: {
    ...pageWidthArgTypes,
...
export const TutorsStatusWarningsPage = {
  render: (args) => {
    const page = createTutorsStatusWarningsPage();
    return createPageWidthWrapper(page, args.pageWidth);
  },
  argTypes: {
    ...pageWidthArgTypes,
...
export const TutorsToolUsagePage = {
  render: (args) => {
    const page = createTutorsToolUsagePage();
    return createPageWidthWrapper(page, args.pageWidth);
  },
  argTypes: {
    ...pageWidthArgTypes,
...
export const TutorsTrainingProgressPage = {
  render: (args) => {
    const page = createTutorsTrainingProgressPage();
    return createPageWidthWrapper(page, args.pageWidth);
  },
  argTypes: {
    ...pageWidthArgTypes,
