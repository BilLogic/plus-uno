...
export default {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    'Full tutor profile shell — layout, sections, and responsive breakpoints. Token notes are in the page component header.',
            },
        },
    },
    argTypes: {
        pageMode: {
            ...
            options: ['shell', 'live'],
            description:
                'shell: static TutorProfilePage props; live: wired sections with dirty detection (Save enables on edits)',
            table: { category: 'Demo' },
        },
        changed: {
            control: 'boolean',
            description: 'shell only — toggles Save buttons on section stubs',
            table: { category: 'State' },
            if: { arg: 'pageMode', eq: 'shell' },
        },
        profileState: {
            control: 'select',
            options: ['unfilled', 'filled'],
            description: 'Profile photo state',
            table: { category: 'State' },
        },
        breakpoint: {
            control: 'select',
            options: ['md', 'lg', 'xl'],
            description: 'ResponsiveFrame viewport',
            ...
            >
                        ...
                        >
                            ...
                            >
                                ...
                                <Tooltip
                                    ...
                                    placement="right"
                                    size="small"
                                    id="tooltip-bi-additional-email"
                                >
                                    <span
                                        style={{
                                            display: 'inline-flex',
                ...
                >
                    ...
                    <div style={{ display: 'flex', gap: 'var(--size-element-gap-sm, 8px)', width: '100%' }}>
                        {[
                            { label: 'Tutor Status', value: 'Lead Tutor' },
                            { label: 'Onboarding Status:', value: 'Complete' },
                            { label: 'Tutoring with PLUS since:', value: '01/29/2026' },
                            { label: 'Assigned Supervisor:', value: 'Albus Dumbledore' },
                        ].map((field) => (
                            <div
                                key={field.label}
                                style={{
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', maxWidth: '580px', width: '100%' }}>
                        <SemesterAtPLUS
                            id="status-semester-interactive"
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--size-small-gap-xs, 4px)' }}>
                        ...
                        <div style={{ display: 'flex', gap: 'var(--size-spacing-space-050, 4px)', alignItems: 'flex-start' }}>
                            <i
                                ...
                                style={{ fontSize: '10px', color: 'var(--color-success)', lineHeight: '20px' }}
                            />
                ...
                >
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', width: '100%' }}>
                        <Button
                            ...
                            fill="filled"
                            size="medium"
                            disabled={!bgMatchingChanged}
                            onClick={handleBgMatchingSave}
                        />
                    </div>
                </div>
            </div>
...
export const Variants = {
    ...
    render: () => (
        ...
        >
            <TutorProfilePage changed={false} profileState="unfilled" />
            <TutorProfilePage changed={true} profileState="filled" />
        </div>
    ),
};
...
export const Interactive = {
    render: (args) =>
        args.pageMode === 'shell' ? (
            <TutorProfilePage changed={args.changed} profileState={args.profileState} />
        ) : (
            <TutorProfileInteractiveDemo profileState={args.profileState} />
        ),
};
