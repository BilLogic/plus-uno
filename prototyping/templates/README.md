...
This directory contains curated templates organized by product pillar. These templates serve as starting points for prototyping and demonstrate best practices for using the PLUS design system.
...
1. **Choose a template** from the appropriate product pillar directory
2. **Copy the template** to your `prototyping/playground/{your-name}/` directory
3. **Customize** the template for your specific prototype
4. **Reference** the design system components and tokens
...
```html
<!-- From prototyping/templates/{pillar}/: -->
...
**Reference**: `prototyping/templates/universal/html-head-template.html` for complete HTML head template
...
1. Create a new directory in the appropriate product pillar folder
2. Include all necessary files
3. Use design tokens consistently (never hardcode values)
4. Follow PLUS design patterns
5. Include comprehensive README.md documentation
6. Test across browsers and screen sizes
7. Reference `develop/standards.md` for coding standards
...
- **Playground**: `../playground/` - For designer-specific prototyping
