/**
 * Profile Organism - Pages
 * 
 * Complete page-level components for profile management.
 * 
 * ## Components in this Category
 * 
 * - **TutorProfile**: Complete tutor profile page that combines all profile elements into a full page experience.
 * 
 * Each page component represents a complete, functional page in the profile management flow.
 */

export default {
  title: 'Organisms/Profile/Pages',
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
        component: 'Complete page-level components for profile management. These are full-page experiences that combine multiple elements, cards, and sections.',
      },
    },
  },
};
