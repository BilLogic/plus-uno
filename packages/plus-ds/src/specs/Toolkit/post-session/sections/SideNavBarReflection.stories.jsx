        ...
        return (
            ...
            >
                <Button
                    ...
                    size="medium"
                    leadingVisual="bars"
                    onClick={() => onTabClick?.('toggle-collapse')}
                />
            </div>
        );
    }
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <SideBarTab
                        text="Add Student"
                        state={activeTab === 'add-student' ? 'selected' : 'enabled'}
                        trailingIcon={
                            <i
...
/**
 * Interactive
 * Fully interactive side nav bar with clickable tabs and expand/collapse functionality
 */
    ...
    return (
        ...
        >
            <div style={{ marginBottom: 'var(--size-section-gap-md)' }}>
                ...
                <p className="text-muted small mb-0">
                    Click the hamburger menu to expand/collapse. Click tabs to navigate. Use controls to switch states.
                </p>
            </div>
            ...
            <div className="d-flex" style={{ gap: 'var(--size-section-gap-lg)' }}>
                <SideNavBar
                    state={isCollapsed ? 'collapsed' : navState}
