...
**34 of 36 fixture cases are recorded** — 34 `captured`. The other 2 are **unreachable**: G1, G2. Each skips by name on the pull-request gate, so nothing about it is measured there — record it (`-f cases=<id>` below) or accept that it gates nothing.
<!-- /census:recorded -->
