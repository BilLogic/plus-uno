...
import SessionsTable from '@/specs/Admin/Session/Tables/SessionsTable/SessionsTable';
import SessionOverviewSection from '@/specs/Admin/Session/Sections/SessionOverviewSection/SessionOverviewSection';
import SessionModal from '@/specs/Admin/Session/Modals/SessionModal/SessionModal';
import { AdminDateRangeFilter } from '@/specs/Admin/Tutor/Elements';
import '@/specs/Admin/Session/Tables/SessionsTable/SessionsTable.scss';
import '@/specs/Admin/Session/Sections/SessionOverviewSection/SessionOverviewSection.scss';
import '@/specs/Admin/Session/Modals/SessionModal/SessionModal.scss';
...
const SessionAdminPage = ({
    ...
    const modalBoundaryRef = useRef(null);
    ...
    // When containModal is set, the modal portal is mounted inside this wrapper
    // (see .plus-modal-boundary in styles/main.scss) so it overlays only the page
    // frame — never the surrounding document (e.g. a Storybook docs page).
...
SessionAdminPage.propTypes = {
    ...
    /** Contain the modal (and backdrop) inside the page frame instead of the browser viewport (used by Storybook docs) */
    containModal: PropTypes.bool,
