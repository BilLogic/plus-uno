...
function DismissibleBadgesDemos() {
    const [badges, setBadges] = React.useState([
        { id: 'success-pressed', text: 'Success', style: 'success' },
        { id: 'info-hover', text: 'Info', style: 'info' },
        { id: 'tertiary-default', text: 'Tertiary', style: 'tertiary' },
        { id: 'secondary-hover', text: 'Secondary', style: 'secondary' },
        { id: 'danger-focus', text: 'Danger', style: 'danger' },
    ]);
    ...
    return (
        <section>
            <h6 className="h6" style={{ marginBottom: '16px' }}>Dismissible Badges</h6>
            <p className="body2-txt" style={{ marginBottom: '16px', color: 'var(--color-on-surface-variant)' }}>
                Interactive badges with dismiss functionality. Click the X to remove them.
            </p>
            <div style={contentVariantCard}>
                <div style={{ display: 'flex', gap: '12px', alignItems: 'center', flexWrap: 'wrap' }}>
                    ...
                    {badges.length === 0 && (
                        <div style={{ padding: '20px', textAlign: 'center', color: 'var(--color-on-surface-variant)' }}>
                            <p className="body2-txt">All badges dismissed! Refresh the page to reset.</p>
                        </div>
                    )}
                </div>
            </div>
...
/** Dismissible badges with interactive demo */
export const Dismissible = () => (
    <div style={badgeGalleryCol}>
        <DismissibleBadgesDemos />
    </div>
);
