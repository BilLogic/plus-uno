...
function manifestYaml() {
  ...
  return [
    ...
    "# Regenerate: npm run generate:skill-surfaces",
    "#",
    "# Paste under `features:` in the Slack app manifest",
    "# (api.slack.com → your app → App Manifest). Declaring a slash command also",
    "# requires the `commands` bot scope; adding it prompts a workspace reinstall.",
    "#",
