                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <SessionRatingField
                                id="session-reflection-part-4-rating"
                                value={sessionRating}
                                ...
                                {improvementAreas.map((area) => {
                                    if (area.id === 'other') {
                                        return (
                                            ...
                                            >
                                                <Checkbox
                                                    id={`session-reflection-part-4-area-${area.id}`}
                                                    name={`session-reflection-part-4-area-${area.id}`}
                                                    label={null}
                                                ...
                                                <div style={{ flex: '1 0 0', minWidth: 0 }}>
                                                    <Textarea
                                                        id="session-reflection-part-4-other-area-input"
                                                        name="session-reflection-part-4-other-area-input"
                                                        variant="short"
                                                        rows={1}
                                                        value={otherAreaText}
                                ...
                                {technicalDifficulties.map((difficulty) => {
                                    if (difficulty.id === 'other') {
                                        return (
                                            ...
                                            >
                                                <Checkbox
                                                    id={`session-reflection-part-4-difficulty-${difficulty.id}`}
                                                    name={`session-reflection-part-4-difficulty-${difficulty.id}`}
                                                    label={null}
                                                ...
                                                <div style={{ flex: '1 0 0', minWidth: 0 }}>
                                                    <Textarea
                                                        id="session-reflection-part-4-other-difficulty-input"
                                                        name="session-reflection-part-4-other-difficulty-input"
                                                        variant="short"
                                                        rows={1}
                        ...
                        >
                            ...
                            <Textarea
                                id="session-reflection-part-4-support-text"
                                name="session-reflection-part-4-support-text"
                                variant="long"
                                rows={2}
                                value={supportText}
...
SessionReflectionPart4.propTypes = {
...
SessionReflectionPart4.defaultProps = {
    students: [
...
export default SessionReflectionPart4;
