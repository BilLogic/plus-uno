...
export default {
  title: 'Specs/Training/Onboarding/Sections',
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
        component: 'Section-level components for training pages.',
      },
    },
  },
};
...
export const Overview = {
  render: () => {
    ...
    const components = [
      { name: 'StudentOverview', description: 'Student overview section' },
      { name: 'MyStudentsStudentOverview', description: 'My Students + Student Overview combined section' },
      { name: 'WelcomeRow', description: 'Welcome row section' },
    ];
