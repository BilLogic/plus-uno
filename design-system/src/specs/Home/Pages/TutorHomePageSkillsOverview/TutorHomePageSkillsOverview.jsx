...
/**
 * TutorHomePageSkillsOverview component
 * Main tutor home page with Skills Overview tab active and circular progress impact card
 * Figma Node: 563-206909 (left page)
 */
const TutorHomePageSkillsOverview = ({
    id,
    tutorName = "John Doe",
    userBadge = "Lead",
    skillsOverviewData,
    ...
    const [activeImpactPage, setActiveImpactPage] = useState(1);
...
TutorHomePageSkillsOverview.propTypes = {
    id: PropTypes.string,
...
export default TutorHomePageSkillsOverview;
