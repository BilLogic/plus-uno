...
The Delete Session page is designed for supervisors to delete and manage sessions.
...
- **Snackbar**: Session canceled notifications (can be toggled)
...
| SessionManagementSnackbar | plus-ds/components | Session canceled notifications |
...
- **Snackbar toggle** - Show/hide session canceled notification
...
/**
 * Delete Session Page - Overview/Static Version
 * Full layout using PageLayout component with sidebar and top bar
 * Includes snackbar notification for session canceled
 */
...
/**
 * Delete Session Page - Interactive Version
    ...
    return (
        <div style={{ height: '100%', width: '100%', position: 'relative', overflow: 'hidden', borderRadius: 'var(--size-card-radius-sm)' }}>
            <PageLayout
                ...
                id="delete-session-page-interactive"
            >
                <MainContent
                    showAlert={showAlert}
                    onAlertClose={() => {}}
...
export const Interactive = {
    ...
    argTypes: {
        snackbar: { control: 'boolean', name: 'Session-canceled snackbar', table: { category: 'State' } },
