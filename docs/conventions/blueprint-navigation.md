...
5. **Confidence — one woven clause, never a trailing label.** Say what you read and how sure you are *inside* the prose; never close an answer with a standalone rating line. *(Adapted on vendoring, 2026-07-29: the Notion original prescribes a labelled rating sign-off. That form is retired here — `agents/uno-bot/AGENT.md` for the bot, stated-basis-inline for IDE work.)* Semantics unchanged: sureness is earned only by rows read this turn; a confident fabrication is the worst outcome.
