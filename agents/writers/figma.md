...
3. Leave the workspace navigable: right prefix, right page, stale things archived not deleted — prefixes and the page map per `docs/conventions/figma-workspace.md`.
