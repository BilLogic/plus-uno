...
export default {
    title: 'Specs/Toolkit/Pre-Session/Elements/School Dropdown',
    component: Select,
    tags: ['autodocs'],
    parameters: {
        layout: 'padded',
...
A searchable dropdown for selecting a school. Used in the create new session form.

## States
- **Unfilled**: Placeholder text "Select a school" with chevron icon
- **Open**: Dropdown expanded with search field and school options (School A, School B, School C)
- **Filled**: Selected school displayed (e.g. "School A")
- **Error**: Red border with validation message "School is required"
...
// School options matching Figma design
const schoolOptions = [
...
/**
 * Reusable label component for the School field
 * Renders "School" label with required asterisk
 *
 * Tokens:
...
const ErrorSelectWrapper = ({ children }) => (
    <div
        className="plus-select-error-wrapper"
        style={{
            // Override the select trigger border to danger color
        }}
    >
        <style>{`
...
/**
 * Overview - All States
 * Shows all visual states of the School Dropdown:
...
export const Overview = () => (
    ...
    >
        <div>
            <h5 className="text-muted mb-2">School Dropdown</h5>
            <p className="text-muted small mb-0">
                Searchable dropdown for selecting a school. Shows all four states from the Figma design.
            </p>
        </div>
        ...
        <section>
            ...
            <p className="body3-txt text-muted mb-2">
                Click the dropdown to see the open state with search field and school options.
            </p>
            <FieldWrapper>
                <SchoolLabel />
                <Select
        ...
        <section>
            ...
            <FieldWrapper>
                ...
                <ErrorMessage message="School is required" />
            </FieldWrapper>
        </section>
    </div>
);
...
/**
 * Interactive
 * Fully interactive school dropdown with validation
 */
export const Interactive = () => {
    const [selectedSchool, setSelectedSchool] = useState('');
    const [touched, setTouched] = useState(false);
    const hasError = touched && !selectedSchool;
    ...
    return (
        ...
        >
            <div>
                <h5 className="text-muted mb-2">Interactive School Dropdown</h5>
                <p className="text-muted small mb-0">
                    Select a school from the dropdown. Click away without selecting to trigger the error state.
                </p>
            </div>
            ...
            <FieldWrapper>
                ...
                {hasError && <ErrorMessage message="School is required" />}
            </FieldWrapper>

            {selectedSchool && (
                <p className="body2-txt" style={{ color: 'var(--color-secondary-text)' }}>
                    Selected: {schoolOptions.find(o => o.value === selectedSchool)?.label}
                </p>
            )}
        </div>
    );
