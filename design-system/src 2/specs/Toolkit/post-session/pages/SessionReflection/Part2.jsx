...
const SessionReflectionPart2 = ({
    ...
    const isOtherSelected = selectedAreas.includes('other');
    const isNextDisabled = selectedAreas.length === 0 || !supportText.trim();
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <SessionRatingField
                                id="session-reflection-part-2-rating"
                                value={sessionRating}
                                ...
                                {improvementAreas.map((area) => {
                                    if (area.id === 'other') {
                                        return (
                                            ...
                                            >
                                                <Checkbox
                                                    id={`session-reflection-part-2-area-${area.id}`}
                                                    name={`session-reflection-part-2-area-${area.id}`}
                                                    label={null}
                                                ...
                                                <div style={{ flex: '1 0 0', minWidth: 0 }}>
                                                    <TextareaVer2
                                                        id="session-reflection-part-2-other-input"
                                                        name="session-reflection-part-2-other-input"
                                                        variant="short"
                                                        rows={1}
                                                        value={otherAreaText}
                        ...
                        >
                            ...
                            <TextareaVer2
                                id="session-reflection-part-2-support-text"
                                name="session-reflection-part-2-support-text"
                                variant="long"
                                rows={2}
                                value={supportText}
...
SessionReflectionPart2.propTypes = {
...
SessionReflectionPart2.defaultProps = {
    students: [
...
export default SessionReflectionPart2;
