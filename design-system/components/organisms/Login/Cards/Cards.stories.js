/**
 * Login Organism - Cards
 * 
 * Card components that contain login forms and authentication interfaces.
 * 
 * ## Components in this Category
 * 
 * - **LoginPortal**: Complete login portal card with multiple variants:
 ...
 * 
 * Each card variant will have its own story showing the complete login flow.
 */

export default {
  title: 'Organisms/Login/Cards',
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
