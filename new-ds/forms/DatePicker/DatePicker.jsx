...
const DatePicker = ({
    ...
    return (
        <Dropdown
            ...
            className={`plus-date-picker-wrapper pdropdown dropdown pdropdown-primary ${size === 'small' ? 'small' : size === 'large' ? 'large' : ''} ${disabled ? 'plus-date-picker-disabled' : ''} ${readOnly ? 'plus-date-picker-readonly' : ''} ${className}`}
            style={style}
        >
