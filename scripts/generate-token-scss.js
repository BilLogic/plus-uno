...
fs.writeFileSync('design-system/src/tokens/_colors_new.scss', colorsScss);
console.log('Generated new colors SCSS file: design-system/src/tokens/_colors_new.scss');
