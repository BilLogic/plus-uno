...
dimensions:
  - id: bundle-completeness
    definition: all required pieces present — Loom + preview + Decisions DB; replica required when the artifact is a prototype; post shape (<=3 questions + NOT-looking-for line) per slack.md (target 100%)
  - id: replica-fidelity
