...
| any blueprint read or write | `docs/connectors/supabase/overview.md` + `docs/connectors/supabase/blueprint.md` + `docs/connectors/supabase/blueprint-navigation.md` |
