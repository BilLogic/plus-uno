...
summary: The only agent that writes to Notion
---
...
- Automations (live): Figma library sync (DS-component PRD creation) · marketplace add/edit entries (`docs/engineering/operations.md`)
- Automation: Notion comment sweep (`docs/engineering/operations.md` — planned)

## Workflow

1. Before any write: confirm the target surface's convention in `docs/connectors/notion.md` and which template applies (New Project vs Maintenance Intake).
