...
**Note**: Logo images are handled by the Logo component (`design-system/src/assets/Logo/`), which uses inline SVG. For logo usage, use `<Logo />` from `@/assets/Logo` instead of static image files.
