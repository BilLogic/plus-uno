 ...
 * Extracted from weekly-report/src/WeeklyReportsListContent.jsx - PageLayout removed.
 */
...
export default function WeeklyReportsListContent() {
    ...
    // Set breadcrumbs and sidebar highlight on mount
    useEffect(() => {
        setBreadcrumbs([
    ...
    return (
        <>
            <div style={{ padding: '20px', background: 'red', color: 'white' }}>DEBUG: WeeklyReportsListContent is rendering!</div>
