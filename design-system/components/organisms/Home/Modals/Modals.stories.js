/**
 * Home Organism - Modals
 * 
 * Modal dialogs used in home page flows.
 * 
 * ## Components in this Category
 * 
 * - **UserFeedbackModal**: Modal for user feedback with types:
 *   - type=problem
 *   - type=question
 *   - type=feedback
 * 
 * Each modal variant will have its own story showing different feedback types.
 */

export default {
  title: 'Organisms/Home/Modals',
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
        component: 'Modal dialogs used in home page flows. These modals provide important user feedback and interaction capabilities.',
      },
    },
  },
};
