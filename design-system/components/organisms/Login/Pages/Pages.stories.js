/**
 * Login Organism - Pages
 * 
 * Complete page-level components for login/authentication.
 * 
 * ## Components in this Category
 * 
 * - **SignInPortal**: Complete sign-in portal page that combines all login elements, cards, and flows into a full page experience.
 * 
 * Each page component represents a complete, functional page in the login/authentication flow.
 */

export default {
  title: 'Organisms/Login/Pages',
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
