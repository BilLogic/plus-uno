...
import { AttendanceRosterRow } from '@/specs/Toolkit/Pre-Session/Elements/PopupModalAttendanceRoster.stories';
import { AvailableButton, UnavailableButton } from '@/specs/Toolkit/Pre-Session/Elements/CTATutorsButton.stories';
import { Recurring_Session } from '@/specs/Toolkit/Pre-Session/Cards/TutorViewSessionManagement.stories';
...
const AttendeesRecurringSessionModalBody = () => (
    <div
...
/**
 * Attendees Recurring Session
 * Confirm session availability modal showing the Attendees tab for a recurring session.
 *
 * Layout:
 * - Header: "Lincoln High School - Thursdays" + close icon
 * - Warning Alert: "Please re-confirm your availability for this recurring session."
 ...
 */
export const Attendees_Recurring_Session = () => (
    <Modal
        renderAs="inline"
        width={672}
        showBottomButtons={false}
        onClose={() => {}}
        body={<AttendeesRecurringSessionModalBody />}
    />
);
