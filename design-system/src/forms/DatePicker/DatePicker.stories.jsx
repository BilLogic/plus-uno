...
export default {
    ...
    parameters: {
        docs: {
            description: {
                component: 'DatePicker component for selecting dates. Supports single date selection and date range selection through paired pickers.'
            }
        }
    },
    argTypes: {
...
/**
 * Overview showing all size and state variants
 */
...
/**
 * Pick Date - Single date selection scenario
 */
...
/**
 * Pick Range - Date range selection scenario
 */
