...
The Create New Session page is designed for supervisors to create and manage sessions.
...
- **Snackbar**: Session management notifications (can be toggled)
...
| SessionManagementSnackbar | plus-ds/components | Session creation notifications |
...
- **Snackbar toggle** - Show/hide session created notification
...
/**
 * Create New Session Page - Overview/Static Version
...
export const Overview = () => (
    <div style={{ maxWidth: '1440px', height: '100%', margin: '0 auto', position: 'relative' }}>
        ...
        >
            <SessionManagementSnackbar type="session created" timestamp="11 mins ago" />
        </div>
    </div>
);

/**
 * Create New Session Page - Interactive Version
    ...
    return (
        <div style={{ height: '100%', width: '100%', position: 'relative', overflow: 'hidden', borderRadius: 'var(--size-card-radius-sm)' }}>
            <PageLayout
                ...
                id="create-new-session-page-interactive"
            >
                <MainContent
                    tabs={tabs}
...
export const Interactive = {
    ...
    argTypes: {
        snackbar: { control: 'boolean', name: 'Session-created snackbar', table: { category: 'State' } },
    },
    args: { snackbar: true },
};
