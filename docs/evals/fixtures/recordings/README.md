...
**34 of 37 fixture cases are recorded** — 34 `captured`. The other 3 are **unreachable**: R21, G1, G2. Each skips by name on the pull-request gate, so nothing about it is measured there — record it (`-f cases=<id>` below) or accept that it gates nothing.
<!-- /census:recorded -->
